 ...
 *  HebcalModes
 *
 *  Original Author: danielbarak@live.com
 *  Original Date: 2014-02-21
 *  Ported to Hubitat on 2019-10-02. See https://github.com/SmartThingsCommunity/SmartThingsPublic/blob/master/smartapps/shabbatholidaymode/shabbat-and-holiday-modes.src/shabbat-and-holiday-modes.groovy for original
 */
